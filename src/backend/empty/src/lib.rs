...
impl device::Device<Backend> for Device {
    ...
    unsafe fn set_image_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }

    unsafe fn set_buffer_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }
    ...
    unsafe fn set_semaphore_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }

    unsafe fn set_fence_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }

    unsafe fn set_framebuffer_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }

    unsafe fn set_render_pass_name(&self, _: &mut (), _: &str) -> Result<(), device::OutOfMemory> {
        unimplemented!()
    }
}
