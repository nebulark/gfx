...
impl Device {
    ...
    -> Result<(), d::OutOfMemory> {
        ...
        if let Some(ref debug_utils_ext) = instance.1 {
            ...
            NAME_BUF[name.len()] = 0;
            let result = debug_utils_ext.0.debug_utils_set_object_name(
                self.raw.0.handle(),
